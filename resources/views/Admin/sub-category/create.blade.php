                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="categorie-name">Categorie Name</label>
                                    <input class="form-control" type="text" id="categorie_name" required="" name="sub_cat_name" placeholder="Enter Category Name">
                                ...
                                @enderror
                                <div class="form-group">
                                    <label for="sub-cat-image">Categorie Image</label><br>
